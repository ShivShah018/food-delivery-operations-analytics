...
│                                   # Build the .pbix per the dashboard guide
│
├── tests/
...
1. **Import data:** Load cleaned CSVs (`data/cleaned/*.csv`) and the processed `data/processed/customer_features.csv` (generated by `feature_engineering.py`)
